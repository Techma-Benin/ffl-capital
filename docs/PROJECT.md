...
- [x] Admin partners : liste, approbation, détail, filter sets ; filtre **Families** (`?family=`, affiliations = `Partner.affiliation`) ; colonnes masquables (préférence `localStorage` `admin-partners-visible-columns`)
