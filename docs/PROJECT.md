...
> Dernière mise à jour : 10 août 2026 (v14 — Integrity success = `integrity_posted` seul ; badge RealTime/Storefront via `liveSaleChannel` ou `ResalePosting.mode`)
