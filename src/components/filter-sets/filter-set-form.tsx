...
export function FilterSetForm({
  ...
  /** Admin/template id this filter set was created from — server copies its limits. */
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    if (showLimits) {
      ...
      // Partner create: limits are admin/template-only, so the server copies
      // them from the source template instead of accepting them here.
